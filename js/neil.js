...
if (localStorage.getItem("reset_2") == undefined) {
  ...
  if (localStorage.getItem("blogbg") != undefined) {
    ...
    document.getElementById("defineBg").innerText = `:root{
      ...
      // --default-bg: url(https://cdn.neily.top/images/Tairitsu-Axium-Crisis-pc.webp);
      ...
      // --mobileday-bg: url(https://cdn.neily.top/images/Tairitsu-Axium-Crisis-mb.webp);
