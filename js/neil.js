...
if (localStorage.getItem("reset_2") == undefined) {
  ...
  function setFont(n) {
    ...
    if (n == "default") {
      ...
      document.body.style.fontFamily = "-apple-system, Consolas_1, BlinkMacSystemFont, 'Segoe UI' , 'Helvetica Neue' , Lato, Roboto, 'Microsoft JhengHei' , 'Microsoft YaHei' , sans-serif";
    }
    else {
      document.documentElement.style.setProperty('--global-font', n);
      document.body.style.fontFamily = "var(--global-font), CascadiaCode, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', Lato, Roboto, 'Microsoft JhengHei', 'Microsoft YaHei', sans-serif";
    }
  ...
  {% folding cyan, 查看电脑背景 %}
  <div class="bgbox">
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/IMG_2767.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/IMG_2767.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/IMG_2894.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/IMG_2894.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_80518034.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_80518034.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_102996140.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_102996140.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_103406887.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_103406887.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_103824706.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_103824706.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_103931711.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_103931711.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_103951571.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_103951571.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/prima_doll_ep1_ed_cover.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/prima_doll_ep1_ed_cover.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/prima_doll_ep2_ed_cover.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/prima_doll_ep2_ed_cover.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/prima_doll_ep3_ed_cover.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/prima_doll_ep3_ed_cover.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/prima_doll_ep4_ed_cover.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/prima_doll_ep4_ed_cover.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/prima_doll_ep5_ed_cover.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/prima_doll_ep5_ed_cover.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/night_img_pc.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/night_img_pc.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/IMG_2285.webp)" class="imgbox" onclick="changeBg('url(https://cdn.neily.top/images/IMG_2285.webp)')"></a>
  </div>
  {% endfolding %}
  ...
  {% folding cyan, 查看手机背景 %}
  <div class="bgbox">
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/IMG_3468.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/IMG_3468.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/IMG_3323.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/IMG_3323.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_98151668.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_98151668.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_100360926.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_100360926.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_101543297.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_101543297.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_95803021.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_95803021.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_101838628.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_101838628.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_102359605.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_102359605.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_103286041.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_103286041.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104098752_0.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104098752_0.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104121656.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104121656.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104202526.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104202526.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104204067.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104204067.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104268098.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104268098.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104270940.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104270940.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104276681.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104276681.webp)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.neily.top/images/Pixiv_104331161.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.neily.top/images/Pixiv_104331161.webp)')"></a>
  </div>
  {% endfolding %}
  ...
  <a id="touhouBox" rel="noopener external nofollow" style="background-image: ${touhou}" class="box apiBox" onclick="changeBg('${touhou}')"></a>
  </div>
  {% endfolding %}
  ...
  <p><center>
  <input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://cdn.neily.top/images/IMG_2285.webp">
  </center></p>
  <p><center>
